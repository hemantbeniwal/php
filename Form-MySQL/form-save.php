...
$insQuery = "INSERT INTO `form`(student_name, emailid, mobile_number, gender, dob, address, city, pincode, state, country, hobbies, qualification, course_applied) value('$studentname', '$email', '$mobile', '$gender', '$dob', '$address', '$city', $pincode, '$state', '$country', '$hobbies', '$qualification', '$course')";
