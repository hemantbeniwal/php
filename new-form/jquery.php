...
<button class="btn" id= "button">click me</button>
    <form action="form_save.php" method="post"id="my_form" enctype="multipart/form-data">
        <table cellpadding="10">
            <tr>
                <td>First Name: <span style="color:red;">*</span></td>
                <td><input type="name" name="first_name" class="name" id="first_name" maxlength="50"
                        value="<?php echo $_SESSION["first_name"] ?? "" ?>">(Max 50 Characters Allowed)
                    <?php if (isset($_SESSION["first_name_error"])) { ?>
                        <span class="first_name_error">
                            <?php
            ...
            <tr>
                ...
                <td><input type="name" name="last_name" class="name" maxlength="50" value="<?= $_SESSION["last_name"] ?? "" ?>">(Max
            ...
            <tr>
                <td>Hobbies</td>
                <td><input type="checkbox" name="hobbies[]" value="drawing" <?= (in_array("drowing", ($_SESSION['hobbies'] ?? []))) ? "checked" : ""; ?>>Drowing
